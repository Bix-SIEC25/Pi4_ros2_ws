...
class ImageSender(Node):
    ...
    def image_callback(self, msg: CompressedImage):
        ...
        self.executor.submit(self._post_image, jpeg_bytes, timestamp)
    ...
    def _post_image(self, jpeg_bytes: bytes, timestamp):
        try:
            ...
            resp = requests.post(self.server_url, files=files, data=data, timeout=8)
